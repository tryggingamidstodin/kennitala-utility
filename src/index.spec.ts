...
describe('kennitala', () => {
  it('should be able to check if kennitala is of a company', () => {
    ...
    expect(kennitala.isCompany("150484-2359drop table('secretTable')")).to.eq(false)
  ...
  it('should make an exception for illegal kennitölur from the year 1969', () => {
    ...
    expect(kennitala.getBirthdate('6902691111').getTime()).to.eq(new Date(1969, 2, 1).getTime())
    ...
    expect(kennitala.getBirthdate('7104691111').getTime()).to.eq(new Date(1969, 4, 1).getTime())
    expect(kennitala.isValidDate('7106691111')).to.eq(true)
    expect(kennitala.isValidDate('7206691111')).to.eq(false)
    expect(kennitala.getBirthdate('7106691111').getTime()).to.eq(new Date(1969, 6, 1).getTime())
    expect(kennitala.isValidDate('7109691111')).to.eq(true)
    expect(kennitala.isValidDate('7209691111')).to.eq(false)
    expect(kennitala.getBirthdate('7109691111').getTime()).to.eq(new Date(1969, 9, 1).getTime())
    expect(kennitala.isValidDate('7111691111')).to.eq(true)
    expect(kennitala.isValidDate('7211691111')).to.eq(false)
    expect(kennitala.getBirthdate('7111691111').getTime()).to.eq(new Date(1969, 11, 1).getTime())
  })
})
